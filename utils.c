...
/**
 * append_hexa_code - Append ascc in hexadecimal code to buffer
...
/**
 * convert_size_number - Casts numbers to the specified sizes
 * @num: Numbers to be casted.
 * @size: Numbers indicating the type to be casted.
 *
 * Return: Casted values of numbers
 */
...
/**
 * convert_size_unsgnd - Casts numbers to the specified sizes
 * @num: Numbers to be casted
 * @size: Numbers indicating the casted type
 *
